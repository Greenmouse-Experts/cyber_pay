...
const WhyCyber = () => {
    ...
    return (
        <div className={`landing-about ${theme === 'light' ? "about" : "darkabout"}`}>
            <Header head="Why CyberPay" body="We identified gaps in the existing payment and collection solutions, hence why we are here to make your life easier." img={why} />
            ...
            <div className="whynow">
                <h2 data-aos="fade-down" data-aos-duration="1100"  className="h2">Why now?</h2>
                ...
                <div className="list_1">
                    <div data-aos="zoom-in-right" data-aos-duration="1100"  className="dark_card">
                        <h2 className="h2"><img src={icon} alt="" />
                            Benefits of the CyberPay App to <span className="text-sky-500">
                                Customers </span>
                        </h2>
                    ...
                    <div data-aos="zoom-in-left" data-aos-duration="1100"  className="list_card">
            ...
            <div className="merchant">
                ...
                Benefits of the CyberPay App to <span className='text-rose-600'>Merchants</span>
                </h2>
                <div className="merchant_list">
                {list.map((item) => (
                        <div data-aos="flip-right" data-aos-duration="1100"  className="list_card">
                            <h3>{item.head}</h3>
                            <p>{item.body}</p>
                        </div>
                    ))}
