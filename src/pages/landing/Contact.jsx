            ...
            >
              ...
              <div className=" flex md:flex-row flex-col justify-between gap-8 ">
                <input
                  type="text"
                  placeholder="Name"
                  className="bg-[#F4F4F4] 2xl:h-[60px] placeholder:text-bluePrimary h-[50px] pl-5 md:w-[373px] w-full"
                />
                <input
                  type="text"
                  placeholder="Email"
                  className="bg-[#F4F4F4] md:w-[373px] w-full 2xl:h-[60px] placeholder:text-bluePrimary  h-[50px] pl-5"
                />
              </div>
              <div className=" ">
                <input
