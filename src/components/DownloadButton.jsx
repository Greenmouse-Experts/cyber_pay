...
const DownloadButton = ({ img, span, text, delay, style, color, radius, store}) => {
  ...
  return (
    ...
    <Link data-aos={style} data-aos-duration={delay}  to={link} className={`download_link flex p-1 w-fit ${radius ?  "rounded-2xl" : "rounded-lg"}  ${color === "black" ? "bg-[#000000] dark:bg-white dark:!text-black" : "bg-[#042E46] dark:!bg-white dark:!text-black "} `} >
